...
class reservation_link(models.Model):
	...
	reservation_link_ref = fields.Char(string='Reservation Ref')
	resvartion_link_id = fields.Char(string='ID')
	reservation_link_email = fields.Char(string='Email')
	reservation_link = fields.Char(string='Reservation Link')
			...
			if rec.partner_id:
				...
				if rec.partner_id.email:
					...
					<div style="width:100%; text-align:center;">
						...
						<b style="color: black;">Click On The Link To See the Reservation Details:</b> 
					</h4>
					<h4 style="margin-top:10px;">
					...
					'email_to': send_to,
					'subject': "Reservation Custom Link ",
					'body_html':
